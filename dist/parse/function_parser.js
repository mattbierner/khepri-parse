...
define(["require", "exports", "bennu/parse", "bennu/lang", "khepri-ast/expression", "khepri-ast/statement",
    ...
    var argumentList, namedArgumentList, argumentsPattern, functionExpression, choice = __o["choice"],
        ...
        argumentElements = eager(listPattern0(((y = expected.bind(null, "pattern")), y(topLevelPattern)),
            ellipsisPattern, ((y0 = expected.bind(null, "non-ellipsis pattern")), y0(topLevelPattern)))),
    ...
    var x0 = label.bind(null, "Named Argument List"),
        ...
        y2 = nodea(next(infixOperator("-"), enumeration(optional(identifierPattern), elements, optional(
            selfPattern))), ast_pattern.ArgumentsPattern.create);
    ...
    var y5, x2 = label.bind(null, "Function Expression"),
        ...
        functionBody = choice(blockStatement, withStatement, tryStatement, then(expression, optional(punctuator(
            "§")))),
        y4 = nodea(enumeration(functionName, next(punctuator("\\"), argumentsPattern), next(punctuator("->"), (
                (y5 = expected.bind(null, "function body")), y5(functionBody)))), ast_expression.FunctionExpression
            .create);
