...
define(["require", "exports", "bennu/parse", "bennu/lang", "khepri-ast/pattern", "./common", "./token_parser",
    ...
    (arrayPattern = label("Array Pattern", ((element = topLevelPattern), nodea(enumeration(optional(false,
        punctuator("?")), between(punctuator("["), punctuator("]"), eager(listPattern(
        expected("array pattern element", element), ellipsisPattern, expected(
            "non-ellipsis array pattern element", element))))), (function(loc, checked,
        elements) {
    ...
    (asPattern = label("As Pattern", nodea(enumeration(attempt(then(identifierPattern, punctuator("#"))),
            expected("object or array pattern", choice(attempt(arrayPattern), objectPattern))),
    ...
    (unpack = label("Unpack", choice(attempt(arrayPattern), objectPattern, asPattern, identifierPattern,
        operatorPattern)));
