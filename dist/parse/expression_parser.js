...
*/define(["require", "exports", "bennu/parse", "bennu/lang", "nu-stream/stream", "khepri-ast/declaration",
    ...
    "khepri-ast/position", "./common", "./token_parser", "./value_parser", "./pattern_parser"
], (function(require, exports, __o, __o0, __o1, ast_declaration, ast_expression, ast_statement, ast_pattern,
    ast_value, __o2, __o3, __o4, __o5, pattern) {
    "use strict";
    var always = __o["always"],
        ...
        arrayLiteral, objectLiteral, functionExpression, operatorExpression, letExpression, primaryExpression,
            ...
            assignmentExpression, expression, topLevelExpression, arg, reducer, x0, y0, blockStatement = late((
                function() {
    ...
    (functionExpression = label("Function Expression", ((functionName = optional(null, next(keyword("function"),
        optional(null, identifier)))), (functionBody = either(blockStatement, then(expression,
        optional(null, punctuator("§"))))), nodea(enumeration(functionName, next(punctuator("\\"),
        pattern.argumentsPattern), next(punctuator("->"), expected("function body",
    ...
    var letBinding = label("Let Binding", nodea(enumeration(expected("pattern", pattern.topLevelPattern),
        punctuator("=", "=:", ":="), expected("bound value", expression)), (function(loc, pattern0,
        rec0, expr) {
    ...
    (assignmentExpression = label("Assignment Expression", rec((function(self) {
        return nodea(append(attempt(enumeration(leftHandReferenceExpression, punctuator("="))),
            enumeration(expected("expression", either(self, expression)))), (function(loc,
            left, op0, right) {
