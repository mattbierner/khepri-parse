...
define(["require", "exports", "bennu/parse", "bennu/lang", "nu-stream/stream", "khepri-ast/declaration",
    ...
    var arrayLiteral, objectLiteral, operatorExpression, letExpression, primaryExpression, accessor,
        ...
        y1, y0, x, arg, y, y8, x4, y9, x3, y7, x10, y16, reducer, y17, x11, x12, y18, x13, y19, x14, y20, x18,
            y24, y33, x26, x25, reducer0, y32, y44, x37, x36, y43, y47, x39, y46, functionExpression = late((
                function() {
    ...
    var args = ((x = label.bind(null, "Arguments")), (arg = expression), (y = node(between(punctuator("("),
        punctuator(")"), ((y0 = sepBy(punctuator(","), ((y1 = expected.bind(null, "argument")), y1(
            arg)))), eager(y0))), (function(loc, x0) {
        (x0.loc = loc);
        return x0;
    }))), x(y)),
        ...
        y3 = node(between(punctuator("["), punctuator("]"), eager(arrayElements)), ast_expression.ArrayExpression
            .create);
    (arrayLiteral = x0(y3));
    var y5, x1 = label.bind(null, "Object Literal"),
        ...
        objectProperties = sepBy(punctuator(","), ((y5 = expected.bind(null, "object property")), y5(
            propertyInitializer))),
        y6 = node(between(punctuator("{"), punctuator("}"), eager(objectProperties)), ast_expression.ObjectExpression
            .create);
    (objectLiteral = x1(y6));
    var letBinding = ((x3 = label.bind(null, "Let Binding")), (y7 = nodea(enumeration(((y8 = expected.bind(null,
        "pattern")), y8(topLevelPattern)), punctuator("=", "=:", ":="), ((x4 = expression), (y9 =
        expected.bind(null, "bound value")), y9(x4))), (function(loc, pattern, rec0, expr) {
        ...
        letBody = expression,
        y10 = nodea(next(keyword("let"), enumeration(((x6 = eager(letBindings)), (y11 = expected.bind(null,
            "let bindings")), y11(x6)), next(keyword("in"), ((y12 = expected.bind(null,
            "let body expression")), y12(letBody))))), ast_expression.LetExpression.create);
    (letExpression = x5(y10));
    var x8, y14, x9, y15, x7 = label.bind(null, "Conditional Expression"),
        y13 = nodea(next(punctuator("?"), enumeration(expression, next(punctuator(":"), ((x8 = expression), (
            y14 = expected.bind(null, "conditional consequent expression")), y14(x8))), next(
            punctuator(":"), ((x9 = expression), (y15 = expected.bind(null,
                "conditional alternate expression")), y15(x9))))), ast_expression.ConditionalExpression.create);
    (conditionalExpression = x7(y13));
    var argumentList = ((x10 = label.bind(null, "Argument List")), (y16 = either(attempt(node(
        operatorExpression, (function(loc, x11) {
            var a = [x11];
            (a.loc = loc);
            return a;
        }))), args)), x10(y16)),
        dotExpression = ((reducer = (function(p, c) {
            return (c.hasOwnProperty("property") ? ast_expression.MemberExpression.create((p ?
                ...
                ast_expression.CallExpression.create((p ? SourceLocation.merge(p.loc, c.loc) : c.loc),
                    p, c));
        })), bind(cons(accessor, ((y17 = either(argumentList, accessor)), many(y17))), ((x11 = foldl.bind(
            null, reducer, null)), (function(z) {
            return always(x11(z));
        })))),
        ...
        binaryOperatorExpression = ((x13 = label.bind(null, "Binary Operator Expression")), (y19 = nodea(cons(
            optional(keyword("_")), either(enumeration(either(keyword("new"), punctuator(".")),
                optional(next(punctuator(","), expression))), enumeration(choice(keyword(
                "instanceof"), punctuator("@"), tokenParser.binaryOperator), optional(next(
                optional(punctuator(",")), expression))))), (function(loc, flipped, op, arg0) {
            var operator0 = ast_expression.OperatorExpression.create(loc, ast_value.BinaryOperator
                .create(loc, op.value), flipped);
        ...
        y21 = between(punctuator("("), punctuator(")"), choice(unaryOperatorExpression,
    ...
    var x17, y23, x16 = label.bind(null, "Primary Expression"),
        y22 = choice(letExpression, conditionalExpression, identifier, literal, arrayLiteral, objectLiteral,
            ...
            })), between(punctuator("("), punctuator(")"), ((x17 = expression), (y23 = expected.bind(null,
                "expression")), y23(x17))));
    ...
    var x21, y27, y28, x22, y29, x20 = label.bind(null, "New Expression"),
        y26 = nodea(next(keyword("new"), enumeration(((x21 = memberExpression), (y27 = expected.bind(null,
                "new object")), y27(x21)), ((x22 = either(args, ((y28 = enumeration(curryExpression)),
                eager(y28)))), (y29 = expected.bind(null, "argument list")), y29(x22)))), ast_expression.NewExpression
            .create);
    ...
    var accessorReducer = (function(p, c) {
        ...
        y30 = binds(enumeration(either(primaryExpression, newExpression), ((y31 = memo(accessor)), many(y31))), (
            (x24 = foldl.bind(null, accessorReducer)), (function() {
                var args0 = arguments;
    ...
    var leftHandSideExpression = ((x25 = label.bind(null, "Call Expression")), (reducer0 = (function(p, c) {
    ...
    })), (y32 = binds(enumeration(memberExpression, ((y33 = either(argumentList, accessor)), many(y33))), (
        (x26 = foldl.bind(null, reducer0)), (function() {
            var args0 = arguments;
        ...
        y34 = binds(enumeration(leftHandSideExpression, many(next(punctuator("@"), ((x28 = either(argumentList,
            leftHandSideExpression)), (y35 = expected.bind(null, "curry argument")), y35(
            x28))))), ((x29 = foldl.bind(null, reducer1)), (function() {
            var args0 = arguments;
    ...
    var y42, x35, x34 = label.bind(null, "Left Hand Reference Expression"),
        y41 = either(operator, binds(enumeration(identifier, ((y42 = memo(accessor)), many(y42))), ((x35 =
            foldl.bind(null, accessorReducer)), (function() {
            var args0 = arguments;
            return always(x35.apply(null, args0));
        }))));
    (leftHandReferenceExpression = x34(y41));
    var leftHandMemberReference = ((x36 = label.bind(null, "Left Hand Reference Expression")), (y43 = binds(
        enumeration(identifier, ((y44 = memo(accessor)), many1(y44))), ((x37 = foldl.bind(null,
        ...
        y45 = rec((function(self) {
            ...
            return nodea(append(attempt(enumeration(leftHandReferenceExpression, punctuator("=", ":="))),
                enumeration(((x39 = either(self, binaryExpression)), (y46 = expected.bind(null,
                    "expression")), y46(x39)))), (function(loc, left, op, right) {
                return ast_expression.AssignmentExpression.create(loc, left, right, (op.value ===
                    ":="));
            }));
        }));
    (assignmentExpression = x38(y45));
    var deleteExpression = ((x39 = label.bind(null, "Delete Expression")), (y46 = node(next(keyword("delete"), (
            (y47 = expected.bind(null, "reference expression")), y47(leftHandMemberReference))),
        ast_expression.DeleteExpression.create)), x39(y46));
